                        ...
                        <div className="flex-1 overflow-y-auto bg-slate-50/50 p-6 md:p-8 custom-scrollbar">
                            <form id="qForm" onSubmit={handleSave} className="grid grid-cols-1 lg:grid-cols-12 gap-6 content-start min-h-full pb-8">
                                ...
                                <div className="lg:col-span-5 flex flex-col gap-4">
                                    ...
                                    {/* Jenis Sumatif Selector - ONLY SHOW FOR SUMATIF */}
                                    {(currentQ.jenis_ujian || '').toUpperCase().includes('SUMATIF') && (
                                        <div className="bg-white p-3 rounded-xl border border-slate-200">
                                            <label className="text-[10px] font-bold text-slate-400 uppercase block mb-1">Jenis Sumatif</label>
                                            <select 
                                                className="w-full font-bold text-slate-700 text-sm outline-none bg-transparent cursor-pointer" 
                                    ...
                                    {/* TP Selector - ONLY SHOW FOR SUMATIF */}
                                    {(currentQ.jenis_ujian || '').toUpperCase().includes('SUMATIF') && (
                                        <div className="bg-white p-3 rounded-xl border border-slate-200">
